////3. 把数组 num_in_rank、num_in_suit 和 card_exists 从 10.5 节的 poker.c 程序中去掉。程序改用 5×2
////的数组来存储牌。数组的每一行表示一张牌。例如，如果数组名为 hand，则 hand[0][0]存储第一
////        张牌的点数，hand[0][1]存储第一张牌的花色。
//
