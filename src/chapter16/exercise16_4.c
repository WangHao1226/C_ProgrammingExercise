////4. 修改 16.3 节的 inventory.c 程序，为结构 part 添加成员 price。insert 函数应该要求用户输入新商品
////的价格。serach 函数和 print 函数应该显示价格。添加一条新的命令，允许用户修改零件的价格。
//
...
// *               user to enter a new price and updates    *
// *               the database.                            *
// **********************************************************/
//void change_price(void){
//    int i, number;
